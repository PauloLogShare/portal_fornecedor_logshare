...
### 🟡 2. APTA COM RESTRIÇÕES (LIBERAÇÃO CONDICIONADA)
...
- **Travas Operacionais Aplicadas Automaticamente**:
  1. Teto de valor de carga fixado em até R$ 300.000,00 ou R$ 500.000,00 por viagem.
  2. Obrigatoriedade de escolta armada para cargas visadas.
  3. Obrigatoriedade de duplo rastreamento com isca móvel.
  4. Consulta prévia obrigatória do motorista na Gerenciadora de Risco com antecedência mínima de 4 horas.
  5. Proibição de subcontratação ou redespacho sem prévia anuência da LogShare.
